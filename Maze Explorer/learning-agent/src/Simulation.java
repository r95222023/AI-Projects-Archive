...
class Simulation {
	...
	public Simulation(Environment wumpusEnvironment, int maxSteps, BufferedWriter outWriter, boolean nonDeterministic, boolean training) {
		...
		agent = new Agent(environment, transferPercept, nonDeterministic, training);
