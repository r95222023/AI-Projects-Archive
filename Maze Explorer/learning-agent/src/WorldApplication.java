...
//	    int seed = rand.nextInt();//-983889151, 1855340765; 734498261;990185018;-1390462475;-239551983
		int seed = 1806225467;//-37482699
	    ...
	    try {
		    ...
		    for (int currTrial = 0; currTrial < numTrials; currTrial++) {
		    	...
		    	Simulation trial = new Simulation(wumpusEnvironment, maxSteps, outputWriter, nonDeterministicMode, training);
